...
if (!function_exists('invoice_company_name')) {
    /**
     * Format company info/address format
     * @return string
     */
    function invoice_company_name()
    {
...
if (!function_exists('invoice_company_address')) {
    /**
     * Format company info/address format
     * @return string
     */
    function invoice_company_address()
    {
        $format = get_option('invoice_company_address');
        $format = _info_format_replace('address', get_option('address'), $format);

        return hooks()->apply_filters('organization_info_text', $format);
    }
}
if (!function_exists('invoice_company_city')) {
    /**
     * Format company info/address format
     * @return string
     */
    function invoice_company_city()
    {
        $format = get_option('invoice_company_city');
        $format = _info_format_replace('city', get_option('city'), $format);

        return hooks()->apply_filters('organization_info_text', $format);
    }
}
if (!function_exists('invoice_company_state')) {
    /**
     * Format company info/address format
     * @return string
     */
    function invoice_company_state()
    {
        $format = get_option('company_state');
        $format = _info_format_replace('state', get_option('state'), $format);

        return hooks()->apply_filters('organization_info_text', $format);
    }
}
if (!function_exists('invoice_company_country')) {
    /**
     * Format company info/address format
     * @return string
     */
    function invoice_company_country()
    {
        $format = get_option('invoice_company_country_code');
        $format = _info_format_replace('country', get_option('country'), $format);

        return hooks()->apply_filters('organization_info_text', $format);
    }
}
if (!function_exists('invoice_company_zip')) {
    /**
     * Format company info/address format
     * @return string
     */
    function invoice_company_zip()
    {
        $format = get_option('invoice_company_postal_code');
        $format = _info_format_replace('zip', get_option('zip'), $format);

        return hooks()->apply_filters('organization_info_text', $format);
    }
}
if (!function_exists('invoice_company_phone')) {
    /**
     * Format company info/address format
     * @return string
     */
    function invoice_company_phone()
    {
        $format = get_option('invoice_company_phonenumber');
        $format = _info_format_replace('zip', get_option('zip'), $format);

        return hooks()->apply_filters('organization_info_text', $format);
    }
}
if (!function_exists('invoice_company_email')) {
    /**
     * Format company info/address format
     * @return string
     */
    function invoice_company_email()
    {
        $format = get_option('smtp_email');
        $format = _info_format_replace('email', get_option('email'), $format);

        return hooks()->apply_filters('organization_info_text', $format);
    }
}
if (!function_exists('invoice_company_vat')) {
    /**
     * Format company info/address format
     * @return string
     */
    function invoice_company_vat()
    {
        $format = get_option('company_vat');
        $format = _info_format_replace('vat', get_option('vat'), $format);
