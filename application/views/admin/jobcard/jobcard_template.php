    ...
    <div class="alert alert-info">
        <div class="row">
            <div id="merge" class="col-md-6">
                <?php
              if (isset($invoice)) {
                  $this->load->view('admin/jobcard/merge_invoice', ['invoices_to_merge' => $invoices_to_merge]);
              }
            ?>
            </div>
            ...
            <div id="expenses_to_bill" class="col-md-6">
                ...
                $this->load->view('admin/jobcard/bill_expenses', ['expenses_to_bill' => $expenses_to_bill]);
            } ?>
            </div>
            <?php } ?>
        </div>
            ...
            if (!isset($invoice_from_project)) { ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php include_once(APPPATH . 'views/admin/jobcard/billing_and_shipping_template.php'); ?>
                    </div>
                    <div class="col-md-6">
